...
class Resume extends JFrame {
    ...
    public Resume() {
        this.setTitle("Resume Process Manager");
    ...
    private JPanel createTitlePanel() {
        ...
        gbc.gridx = 0;
        JLabel title = new JLabel("Resume Process Manager");
        ...
        this.pidField.addActionListener((e) -> this.resumeProcess());
        gbc.gridy = 2;
        panel.add(this.pidField, gbc);
        JButton blockBtn = this.createButton("Resume Process", new Color(220, 53, 69));
        blockBtn.addActionListener((e) -> this.resumeProcess());
        gbc.gridy = 3;
    ...
    private JPanel createSearchPanel() {
        ...
        this.searchField.addKeyListener(new KeyAdapter() {
            {
                Objects.requireNonNull(Resume.this);
            }

            public void keyReleased(KeyEvent e) {
                Resume.this.filterTable(Resume.this.searchField.getText());
            }
        });
    ...
    private void styleTable() {
        ...
        this.table.getColumnModel().getColumn(5).setCellRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable t, Object v, boolean s, boolean f, int r, int c) {
                ...
                if (!s) {
                    lbl.setBackground(Resume.TABLE_BG);
                    if ("Suspended".equals(v)) {
    ...
    private void resumeProcess() {
        try {
            ...
            } else if (!"Suspended".equals(p.status)) {
                this.msg("Only Suspended processes can be Resume", "Warning", 2);
            } else {
                p.status = "Ready";
                this.msg("Process Resume successfully", "Success", 1);
                this.refresh();
            }
