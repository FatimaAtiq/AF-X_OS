...
public class MemoryManagement extends JFrame {
    public MemoryManagement() {
        ...
        JLabel titleLabel = new JLabel("Memory Management") {
            {
                Objects.requireNonNull(MemoryManagement.this);
            }
        ...
        JPanel gridPanel = new JPanel(new GridLayout(1, 2, 25, 25));
        gridPanel.setOpaque(false);
        gridPanel.add(this.createProcessButton("Contiguious Memory", "➕", new Color(88, 166, 255), (e) -> new ContiguousMemoryGUI()));
        gridPanel.add(this.createProcessButton("Non Contigious Memory", "\ud83d\uddd1", new Color(255, 107, 107), (e) -> new NonContigious()));
