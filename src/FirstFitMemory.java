...
class FirstFitMemory extends JFrame {
    private int[] blocks;
    private int[] processes;
    private JTable table;
    private DefaultTableModel model;

    public FirstFitMemory(int[] blocks, int[] processes) {
        this.blocks = blocks;
        this.processes = processes;
        this.setTitle("First Fit Memory Allocation");
        ...
        this.model = new DefaultTableModel(columnNames, 0) {
            {
                Objects.requireNonNull(FirstFitMemory.this);
            }
        ...
        this.table.setSelectionBackground(new Color(88, 166, 255, 100));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            new FirstFitMemory(blocks, processes);
        });
    }
}
