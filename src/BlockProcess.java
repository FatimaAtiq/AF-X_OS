...
class BlockProcess extends JFrame {
    ...
    private JPanel createTitlePanel() {
        ...
        gbc.gridx = 0;
        JLabel title = new JLabel("Block Process Manager");
        ...
        this.pidField.addActionListener((e) -> this.blockProcess());
        gbc.gridy = 2;
        panel.add(this.pidField, gbc);
        JButton blockBtn = this.createButton("Block Process", new Color(220, 53, 69));
        blockBtn.addActionListener((e) -> this.blockProcess());
        gbc.gridy = 3;
    ...
    private JPanel createSearchPanel() {
        ...
        this.searchField.addKeyListener(new KeyAdapter() {
            {
                Objects.requireNonNull(BlockProcess.this);
            }

            public void keyReleased(KeyEvent e) {
                BlockProcess.this.filterTable(BlockProcess.this.searchField.getText());
            }
        });
    ...
    private void styleTable() {
        ...
        this.table.getColumnModel().getColumn(5).setCellRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable t, Object v, boolean s, boolean f, int r, int c) {
                ...
                if (!s) {
                    lbl.setBackground(BlockProcess.TABLE_BG);
                    if ("Running".equals(v)) {
    ...
    private void blockProcess() {
        try {
            ...
            if (p == null) {
                ...
                p.status = "Blocked";
                this.msg("Process blocked successfully", "Success", 1);
                this.refresh();
            }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(BlockProcess::new);
    }
