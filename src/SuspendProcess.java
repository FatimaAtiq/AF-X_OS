...
class SuspendProcess extends JFrame {
    ...
    public SuspendProcess() {
        this.setTitle("Block Process Manager");
    ...
    private JPanel createTitlePanel() {
        ...
        gbc.gridx = 0;
        JLabel title = new JLabel("Suspend Process Manager");
        ...
        this.pidField.addActionListener((e) -> this.suspendProcess());
        gbc.gridy = 2;
        panel.add(this.pidField, gbc);
        JButton blockBtn = this.createButton("Suspend Process", new Color(220, 53, 69));
        blockBtn.addActionListener((e) -> this.suspendProcess());
        gbc.gridy = 3;
    ...
    private JPanel createSearchPanel() {
        ...
        this.searchField.addKeyListener(new KeyAdapter() {
            {
                Objects.requireNonNull(SuspendProcess.this);
            }

            public void keyReleased(KeyEvent e) {
                SuspendProcess.this.filterTable(SuspendProcess.this.searchField.getText());
            }
        });
    ...
    private void styleTable() {
        ...
        this.table.getColumnModel().getColumn(5).setCellRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable t, Object v, boolean s, boolean f, int r, int c) {
                ...
                if (!s) {
                    lbl.setBackground(SuspendProcess.TABLE_BG);
                    if ("Ready".equals(v)) {
    ...
    private void suspendProcess() {
        try {
            ...
            } else if (!"Ready".equals(p.status)) {
                this.msg("Only Running processes can be blocked", "Warning", 2);
            } else {
                p.status = "Suspended";
                this.msg("Process Suspended successfully", "Success", 1);
                this.refresh();
            }
        } catch (Exception var3) {
            this.msg("Invalid PID", "Error", 0);
        }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(SuspendProcess::new);
    }
