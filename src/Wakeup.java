...
class Wakeup extends JFrame {
    ...
    public Wakeup() {
        this.setTitle("Wakeup Process Manager");
    ...
    private JPanel createTitlePanel() {
        ...
        gbc.gridx = 0;
        JLabel title = new JLabel("Wakeup Process Manager");
        ...
        JButton blockBtn = this.createButton("Wakeup Process", new Color(220, 53, 69));
    ...
    private JPanel createSearchPanel() {
        ...
        this.searchField.addKeyListener(new KeyAdapter() {
            {
                Objects.requireNonNull(Wakeup.this);
            }

            public void keyReleased(KeyEvent e) {
                Wakeup.this.filterTable(Wakeup.this.searchField.getText());
            }
        });
    ...
    private void styleTable() {
        ...
        this.table.getColumnModel().getColumn(5).setCellRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable t, Object v, boolean s, boolean f, int r, int c) {
                ...
                if (!s) {
                    lbl.setBackground(Wakeup.TABLE_BG);
                    if ("Blocked".equals(v)) {
    ...
    private void blockProcess() {
        try {
            ...
            if (p == null) {
                ...
                this.msg("Only Blocked processes can be wakeup", "Warning", 2);
            } else {
                p.status = "Ready";
                this.msg("Process Wakeup successfully", "Success", 1);
                this.refresh();
            }
